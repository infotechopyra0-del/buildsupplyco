...
export default function WhatsAppChat() {
  ...
  const whatsappNumber = '917011506187'
  const message = `Hello! I'm interested in Concreed products and solutions. Could you please help me with availability and pricing?`
          ...
          >
            ...
            <div className="bg-green-500 text-white p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-semibold">Concreed</h3>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-800 mb-2">
                      Hi there! Welcome to Concreed. How can we help you today?
                    </p>
                    <p className="text-xs text-gray-500">
                      • Product availability & specifications
                    </p>
                    <p className="text-xs text-gray-500">
                      • Pricing, quotations & bulk orders
                    </p>
                    <p className="text-xs text-gray-500">
